...
public class ObservableArrayList<T> extends ArrayList<T> implements ObservableList<T> {
  ...
  @Override public void addOnListChangedCallback(OnListChangedCallback listener) {
    if (mListeners == null) {
  ...
  @Override public void removeOnListChangedCallback(OnListChangedCallback listener) {
    if (mListeners != null) {
  ...
  @Override public void add(int index, T object) {
    super.add(index, object);
    notifyAdd(index, 1);
  }

  @Override public boolean addAll(@NonNull Collection<? extends T> collection) {
    int oldSize = size();
  ...
  @Override public boolean addAll(int index, @NonNull Collection<? extends T> collection) {
