...
public class PasswordEditText extends EditText {
   ...
   */
  @SuppressWarnings("FieldCanBeLocal") private static int EXTRA_TAPPABLE_AREA = 50;

  @DrawableRes private int showPwIcon = R.drawable.eye1;

  @DrawableRes private int hidePwIcon = R.drawable.eye2;
  ...
  /**
   * This method toggles the visibility of the icon and takes care of switching the input
   * type
