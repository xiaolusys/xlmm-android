...
public class ClearEditText extends EditText {
   ...
   * 默认的清除按钮图标资源
   */
  private static final int ICON_CLEAR_DEFAULT = com.jimei.library.R.drawable.clear_text;
  ...
  private void init(Context context, AttributeSet attrs) {
    ...
    TypedArray typedArray =
        context.obtainStyledAttributes(attrs, com.jimei.library.R.styleable.ClearEditText);
    // 获取清除按钮图标资源
    int iconClear =
        typedArray.getResourceId(com.jimei.library.R.styleable.ClearEditText_iconClear, ICON_CLEAR_DEFAULT);
