...
class BackgroundLayout extends FrameLayout {
  ...
  @SuppressWarnings("deprecation") private void init() {
    setBaseColor(getContext().getResources().getColor(com.jimei.library.R.color.transparent));
    // Remove background, we will drawing background using base color
    setBackgroundColor(getContext().getResources().getColor(com.jimei.library.R.color.transparent));
  }
