...
public class WheelView extends View {
  ...
  public WheelView(Context context, AttributeSet attrs) {
    ...
    if (attrs != null) {
      ...
      mGravity = a.getInt(R.styleable.wheelview_gravity_xx, Gravity.CENTER);
      textColorOut = a.getColor(R.styleable.wheelview_textColorOut, textColorOut);
      textColorCenter =
          a.getColor(R.styleable.wheelview_textColorCenter, textColorCenter);
  ...
  @Override protected void onDraw(Canvas canvas) {
    ...
    while (counter < itemsVisible) {
      ...
      double radian =
          ((itemHeight * counter - itemHeightOffset) * Math.PI) / halfCircumference;
