...
public class QuickHideBehavior extends CoordinatorLayout.Behavior<View> {
  ...
  @Override public void onNestedScroll(CoordinatorLayout coordinatorLayout, View child,
  ...
  @Override public boolean onNestedFling(CoordinatorLayout coordinatorLayout, View child,
  ...
  private void restartAnimator(View target, float value) {
    ...
    mAnimator =
        ObjectAnimator.ofFloat(target, View.TRANSLATION_Y, value).setDuration(250);
    mAnimator.start();
  }
