...
public class IndexAsyncTask extends AsyncTask<Integer, Integer, String> {
    ...
    private static final String TAG = "IndexAsyncTask";
    private String url;
    private View view;
    ...
    public void parseIndexFromJson(String jsonData) {
        try {
            ...
            nvzhuang_gridview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                Bundle bundle = null;
                String product_id;
                String model_id;
                String name = null;
            ...
            child_gridview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> arg0,
                    ...
                    try {
                        product_id = child_list.get(position).id;
                        model_id = child_list.get(position).model_id;
                        name = child_list.get(position).name;
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
