...
public class CartsPayInfoActivity extends BaseSwipeBackCompatActivity
        implements View.OnClickListener, RadioGroup.OnCheckedChangeListener, SmoothCheckBox.OnCheckedChangeListener {
                ...
                .subscribe(new ServiceResponse<CartsPayinfoBean>() {
                    ...
                    public void onNext(CartsPayinfoBean cartsPayinfoBean) {
                        if (cartsPayinfoBean != null) {
                            ...
                            List<CartsPayinfoBean.payExtrasEntityApp> payExtrasEntities = cartsPayinfoBean.getmPayExtras();
                            ...
                            if (payExtrasEntities.size() > 1) {
                                ...
                                payExtrasEntityApp =
                                        payExtrasEntities.get(0);

                                pay_extras = "pid:"
                                        + payExtrasEntityApp.getPid()
                                        + ":value:" + payExtrasEntityApp.getValue() + ";"
                                        + "pid:"
                                        + payExtrasEntityAppBudget.getPid()
                                        + ":budget:"
                                        + payExtrasEntityAppBudget.getValue();

                                extraBudget.setText("余额 " + budgetCash + " 本次可用 " + payExtrasEntityAppBudget.getValue());
                            ...
                            total_feeInfo = cartsPayinfoBean.getTotalFee() - payExtrasEntityApp.getValue();
    ...
    private void payWithBudget(String pay_method) {
        ...
        Subscription subscription = TradeModel.getInstance()
                ...
                .subscribe(new ServiceResponse<BudgetPayBean>() {
                    ...
                    @Override
                    public void onNext(BudgetPayBean responseBody) {
