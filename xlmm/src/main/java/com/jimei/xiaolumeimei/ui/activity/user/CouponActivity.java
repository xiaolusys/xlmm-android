...
public class CouponActivity extends BaseSwipeBackCompatActivity {
  ...
  @Bind(R.id.layout_coupon_empty) FrameLayout rl_empty;
  @Bind(R.id.sv_frame_coupon) ScrollView sv_frame_coupon;
  @Bind(R.id.ll_unused) LinearLayout unusedLayout;
  @Bind(R.id.ll_used) LinearLayout usedLayout;
  @Bind(R.id.ll_past) LinearLayout pastLayout;
  @Bind(R.id.lv_unused_coupon) ListView lv_unused_coupon;
  @Bind(R.id.lv_timeout_coupon) ListView lv_timeout_coupon;
  @Bind(R.id.lv_used_coupon) ListView lv_used_coupon;
  int unused_num = 0;
