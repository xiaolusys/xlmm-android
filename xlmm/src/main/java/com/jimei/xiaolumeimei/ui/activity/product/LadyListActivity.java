 ...
 */
public class LadyListActivity extends BaseSwipeBackCompatActivity implements View.OnClickListener {
    @Bind(R.id.text_1)
    TextView textView1;
    @Bind(R.id.text_2)
    TextView textView2;
    ...
    protected void initData() {
        ...
        Subscription subscribe = ProductModel.getInstance()
                ...
                .subscribe(new ServiceResponse<LadyListBean>() {
                    @Override
                    public void onNext(LadyListBean ladyListBean) {
    ...
    private void loadMoreData(int page, int page_size,String orderBy) {
        if (orderBy != null) {
            Subscription subscribe = ProductModel.getInstance()
                    ...
                    .subscribe(new ServiceResponse<LadyListBean>() {
                        @Override
                        public void onNext(LadyListBean productListBean) {
