...
public class UserDrawCashActivity extends BaseSwipeBackCompatActivity implements SmoothCheckBox.OnCheckedChangeListener, TextWatcher, View.OnClickListener {
                    ...
                    public void onNext(UserWithdrawResult resp) {
                        switch (resp.getCode()) {
                            case 0:
                                ...
                                startActivity(new Intent(UserDrawCashActivity.this, DrawCashCompleteActivity.class));
                                finish();
                                break;
                            default:
