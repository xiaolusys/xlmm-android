...
public class MamaInfoActivity extends BaseSwipeBackCompatActivity
    ...
    @Bind(R.id.imgUser)
    ImageView imgUser;
    @Bind(R.id.btn_two_dimen)
    TextView btn_two_dimen;
    @Bind(R.id.tv_cashinfo)
    TextView tv_cashinfo;
    @Bind(R.id.rl_chart)
    RelativeLayout rl_chart;
    @Bind(R.id.tv_cash)
    TextView tv_cash;
    @Bind(R.id.btn_chooselist)
    TextView btn_chooselist;
    @Bind(R.id.tv_liveness)
    TextView tv_liveness;
    @Bind(R.id.img_liveness)
    com.jimei.xiaolumeimei.widget.RotateTextView img_liveness;
    @Bind(R.id.chart1)
    LineChart mChart;
    @Bind(R.id.img_left)
    ImageView img_left;
    @Bind(R.id.img_right)
    ImageView img_right;
    @Bind(R.id.rl_empty_chart)
    RelativeLayout rl_empty_chart;
    @Bind(R.id.tv_visit2)
    TextView tv_today_visit2;
    @Bind(R.id.tv_today_order2)
    TextView tv_today_order2;
    @Bind(R.id.tv_today_fund2)
    TextView tv_today_fund2;
    @Bind(R.id.rl_mama_info)
    RelativeLayout rlMamaInfo;
    @Bind(R.id.rl_order)
    LinearLayout rlOrder;
    @Bind(R.id.rl_chooselist)
    ...
    protected void initData() {
        ...
        Subscription subscribe3 = MamaInfoModel.getInstance()
                ...
                .subscribe(new ServiceResponse<MamaFortune>() {
                    @Override
                    public void onNext(MamaFortune fortune) {
    ...
    void get_his_refund() {
        ...
        Subscription subscribe = MMProductModel.getInstance()
                ...
                .subscribe(new ServiceResponse<RecentCarryBean>() {
                    @Override
                    public void onNext(RecentCarryBean recentDayBean) {
