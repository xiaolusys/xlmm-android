...
public class MamaInfoActivity extends BaseSwipeBackCompatActivity
  ...
  private void initPointBean(AgentInfoBean pointBean) {
  ...
  private void initMMview(MamaFortune fortune) {
  ...
  private void initShareInfo(MMShoppingBean mmShoppingBean) {
    ...
    switch (v.getId()) {
      ...
      case R.id.img_left:
        ...
        tv_today_order2.setText(
            Integer.toString((int) (show_refund.get(show_refund.size() - 1).getOrderNum())));
      ...
      case R.id.rl_fans:
        ...
        startActivity(new Intent(MamaInfoActivity.this, MMFans1Activity.class));
        break;
      ...
      case R.id.visit_layout:
        Intent intent5 = new Intent(new Intent(MamaInfoActivity.this, MamaVisitorActivity.class));
  ...
  @Override public void onValueSelected(Entry e, int dataSetIndex, Highlight h) {
    ...
    tv_today_visit2.setText(Integer.toString(show_refund.get(e.getXIndex()).getVisitorNum()));
