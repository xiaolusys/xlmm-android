...
public class InformationActivity extends BaseSwipeBackCompatActivity
  ...
  @Bind(R.id.user_img) CircleImageView imgUser;
  @Bind(R.id.nick_name) MyPreferenceView nickNameView;
  @Bind(R.id.bind_phone) MyPreferenceView bindPhoneView;
  @Bind(R.id.edit_pwd) MyPreferenceView editPwdView;
  @Bind(R.id.edit_address) MyPreferenceView editAddressView;
  @Bind(R.id.setting) MyPreferenceView settingView;
  @Bind(R.id.login_out) MyPreferenceView login_out;

  UserInfoBean userinfo;
  @Bind(R.id.debug) LinearLayout debug;
  private int num;
