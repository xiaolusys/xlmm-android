...
import com.jimei.xiaolumeimei.ui.activity.user.SettingAccountActivity;
import com.jimei.xiaolumeimei.ui.activity.user.SettingMyInfoActivity;
...
public class SettingFragment extends Fragment implements OnClickListener {
  ...
  @Override public View onCreateView(LayoutInflater inflater, ViewGroup container,
    ...
    Toast toast =
        Toast.makeText(getActivity(), "Welcome " + login_name_data, Toast.LENGTH_SHORT);
    toast.show();
  ...
  public void initview() {
    ...
    if (login_data.equals(test_value)) {
      ...
      quit_text.setOnClickListener(v -> {
      ...
      Toast toast1 =
          Toast.makeText(getActivity(), "登陆状态：" + login_data, Toast.LENGTH_SHORT);
      toast1.show();
