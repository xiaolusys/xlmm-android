...
public class WalletDetailActivity extends BaseSwipeBackCompatActivity {
  ...
  @Bind(R.id.date_1) TextView dateTv1;
  @Bind(R.id.date_2) TextView dateTv2;
  @Bind(R.id.date_3) TextView dateTv3;
  @Bind(R.id.tv_type) TextView typeTv;
  @Bind(R.id.tv_date) TextView dateTv;
  @Bind(R.id.tv_number) TextView numberTv;
  @Bind(R.id.tv_account) TextView accountTv;
