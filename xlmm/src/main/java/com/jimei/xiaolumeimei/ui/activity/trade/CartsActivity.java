 ...
 */
public class CartsActivity extends BaseSwipeBackCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.confirm:
                ...
                Intent intent = new Intent(CartsActivity.this, CartsPayInfoActivity.class);
                StringBuilder sb = new StringBuilder();
                if (ids.size() > 0) {
                    String s = apendString(sb);

                    intent.putExtra("ids", s);
                    JUtils.Log("CartsActivity", s);
                    ...
                    public void onNext(List<CartsInfoBean> cartsinfoBeans) {
                        if ((cartsinfoBeans != null) && (cartsinfoBeans.size() > 0)) {
                            ...
                            goMain1.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(View v) {
                                    startActivity(new Intent(CartsActivity.this, MainActivity.class));
                                    finish();
                                }
                            });
                ...
                public void onClick(View v) {
                    if (mList.size() == 1) {
                        if (cartsInfoBean.getNum() > 1) {
                            ...
                            new MaterialDialog.Builder(CartsActivity.this).
                                    title("删除商品").
                                    content("您确定要删除吗？").
                                    positiveText("确定").
                                    negativeText("取消").
    ...
    class CartsHisAdapetr extends RecyclerView.Adapter<CartsHisAdapetr.CartsHisVH> {
        ...
        public void onBindViewHolder(CartsHisVH holder, int position) {
            ...
            holder.rebuy.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    MobclickAgent.onEvent(CartsActivity.this, "ReAddCartsID");
                    Subscription subscribe = CartsModel.getInstance()
