 ...
 */
public class WaitPayOrdersFragment extends Fragment {

  String TAG = "WaitPayOrdersFragment";
  ...
  private WaitPayOrdersListAdapter adapter;
  private int page = 2;
  private Subscription subscription1;
  private Subscription subscription2;
  private MaterialDialog materialDialog;

  public static WaitPayOrdersFragment newInstance(String title) {
    WaitPayOrdersFragment allOrdersFragment = new WaitPayOrdersFragment();
  ...
  private void initViews(View view) {
    ...
    adapter = new WaitPayOrdersListAdapter(getActivity());
