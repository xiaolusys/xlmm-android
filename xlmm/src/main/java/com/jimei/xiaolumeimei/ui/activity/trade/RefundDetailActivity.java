...
public class RefundDetailActivity extends BaseSwipeBackCompatActivity
  ...
  @Bind(R.id.tv_order_id) TextView orderIdTv;
  @Bind(R.id.tv_status) TextView statusTv;
  @Bind(R.id.ll_return) LinearLayout returnLayout;
  @Bind(R.id.btn_return_addr) Button returnAddrBtn;
  @Bind(R.id.et_logistics_info) EditText logInfoEt;
  @Bind(R.id.sdv) ImageView goodImageView;
  @Bind(R.id.tv_good_name) TextView goodNameTv;
  @Bind(R.id.tv_good_price) TextView goodPriceTv;
  @Bind(R.id.tv_good_size) TextView goodSizeTv;
  @Bind(R.id.tv_good_num) TextView goodNumTv;
  @Bind(R.id.num) TextView numTv;
  @Bind(R.id.price) TextView priceTv;
  @Bind(R.id.reason) TextView reasonTv;
  @Bind(R.id.tv_order_create_time) TextView createTimeTv;
  @Bind(R.id.tv_order_last_time) TextView lastTimeTv;
  @Bind(R.id.tv_order_last_state) TextView lastStateTv;
  @Bind(R.id.ll_last) LinearLayout lastLayout;
  @Bind(R.id.round_image) RoundCornerImageView imageView;
  @Bind(R.id.refund_type) TextView refundTypeTv;
  @Bind(R.id.refund_layout) LinearLayout refundLayout;
