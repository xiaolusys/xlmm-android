...
public class SystemBarTintManager {
   ...
   * @param drawable The drawable to use as the background, or null to remove it.
   */
  @SuppressWarnings("deprecation") public void setStatusBarTintDrawable(
      Drawable drawable) {
    if (mStatusBarAvailable) {
   ...
   * @param drawable The drawable to use as the background, or null to remove it.
   */
  @SuppressWarnings("deprecation") public void setNavigationBarTintDrawable(
      Drawable drawable) {
    if (mNavBarAvailable) {
  ...
  private void setupNavBarView(Context context, ViewGroup decorViewGroup) {
    ...
    if (mConfig.isNavigationAtBottom()) {
      params =
          new LayoutParams(LayoutParams.MATCH_PARENT, mConfig.getNavigationBarHeight());
      params.gravity = Gravity.BOTTOM;
    } else {
      params =
          new LayoutParams(mConfig.getNavigationBarWidth(), LayoutParams.MATCH_PARENT);
  ...
  public static class SystemBarConfig {
     ...
     *
     * @return True if navigation should appear at the bottom of the screen, False
     * otherwise.
     */
    ...
    /**
     * Get the width of the system navigation bar when it is placed vertically on the
     * screen.
     *
