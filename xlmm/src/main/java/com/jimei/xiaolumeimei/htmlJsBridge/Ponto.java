...
public class Ponto {
   ...
   */
  public void invoke(String className, String methodName, String params,
  ...
  private class PontoProtocol {
     ...
     * @param async
     */
    @JavascriptInterface public void request(String execContext, String className,
        String methodName, String params, String callbackId, String async) {
     ...
     */
    @JavascriptInterface public void response(String execContext, String callbackId,
        String params) {
     ...
     * @param params The parameters associated with the response.
     */
    private void javascriptCallback(final String callbackId, final int type,
        final String params) {
