...
//			mContainer = (LinearLayout) getChildAt(0);
	...
	public void initDatas(HorizontalScrollViewAdapter mAdapter)
	{
		...
		if (mChildWidth == 0 && mChildHeight == 0)
		{
			...
			Log.i(TAG, "LayoutParams width "+ p.width + ", height " + p.height);
			mChildHeight = p.height;
			mChildWidth = p.width;
			Log.i(TAG, "mScreenWitdh "+mScreenWitdh+" width "+view.getMeasuredWidth() + ", height " + view.getMeasuredHeight());
