...
public class LargeImageView extends UpdateView
    implements IPhotoView, ImageManager.OnImageLoadListenner {
  ...
  @Override protected void onUpdateWindow(Rect visiableRect) {
  ...
  @SuppressLint("DrawAllocation") @Override protected void onDraw(Canvas canvas) {
    ...
    List<ImageManager.DrawData> drawData =
        imageManager.getDrawData(imageScale, imageRect);
  ...
  @Override public void onBlockImageLoadFinished() {
    notifyInvalidate();
  }

  @Override public void onImageLoadFinished(int imageWidth, int imageHeight) {
    notifyInvalidate();
  }
}
