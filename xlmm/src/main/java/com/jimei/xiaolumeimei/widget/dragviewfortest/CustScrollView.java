package com.jimei.xiaolumeimei.widget.dragviewfortest;
...
public class CustScrollView extends ScrollView implements ObservableView {
  ...
  @SuppressLint("NewApi") @Override public boolean isTop() {
