package com.jimei.xiaolumeimei.widget.badgelib;
...
import com.jimei.xiaolumeimei.widget.badgelib.core.BadgeManager;
import com.jimei.xiaolumeimei.widget.badgelib.core.BadgeObserver;
import com.jimei.xiaolumeimei.widget.badgelib.core.container.BadgeOverlay;
import com.jimei.xiaolumeimei.widget.badgelib.core.mutable.BadgeMutable;
import com.jimei.xiaolumeimei.widget.badgelib.core.style.AbsBadgeStyle;
import com.jimei.xiaolumeimei.widget.badgelib.core.style.BadgeStyleFactory;
...
public class BadgeRelativeLayout extends RelativeLayout
    implements BadgeManager, BadgeObserver {
  ...
  @Override public final FigureBadge createFigureBadge(int viewId, Class badgeStyle) {
  ...
  @Override public FigureBadge createFigureBadge(View view,
      Class<? extends FigureStyle> badgeStyle) {
  ...
  @Override public final DotBadge createDotBadge(int viewId, Class badgeStyle) {
    View childView = findViewById(viewId);
  ...
  @Override public BadgeMutable findBadge(int viewId) {
    return mOverlay.getBadgeMutable(viewId);
  }

  @Override public BadgeMutable findBadge(View view) {
  ...
  @Override public final void clearAllBadges() {
   ...
   */
  private void calcuIntrinsicHitRect(View childView, Rect outRect, BadgeMutable mutable,
      int id) {
  ...
  @Override public final void onBadgeStateChange() {
    mOverlay.invalidate();
  }
  ...
  @Override public final View getChildAt(int index) {
    return super.getChildAt(index);
  }

  @Override public final int indexOfChild(View child) {
    return super.indexOfChild(child);
  }

  @Override public final void bringChildToFront(@NonNull View child) {
