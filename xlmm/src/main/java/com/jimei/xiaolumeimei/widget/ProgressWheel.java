...
public class ProgressWheel extends View {
   ...
   * because this method is called after measuring the dimensions of MATCH_PARENT &
   * WRAP_CONTENT.
  ...
  private void parseAttributes(TypedArray a) {
    ...
    barWidth =
        (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, barWidth, metrics);
    rimWidth =
        (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, rimWidth, metrics);
    circleRadius =
        (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, circleRadius,
            metrics);
   ...
   * the smoothness when information a progress
   */
