package com.jimei.xiaolumeimei.widget.citypicker;
...
public class CityPicker extends LinearLayout {
	...
	public String getCity_receiver_state() {
		receiver_state = provincePicker.getSelectedText();

		return receiver_state;
	}

	public String getCity_receiver_city() {
		receiver_city = provincePicker.getSelectedText();

		return receiver_city;
	}
	public String getCity_receiver_district() {
		receiver_district = provincePicker.getSelectedText();
