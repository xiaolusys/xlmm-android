...
public class AutoToolbar extends Toolbar {
  ...
  public AutoToolbar(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    TypedArray menuA = context.getTheme()
        .obtainStyledAttributes(attrs, R.styleable.AppCompatTheme, defStyleAttr,
  ...
  private int loadTextSizeFromTextAppearance(int textAppearanceResId) {
    TypedArray a =
        getContext().obtainStyledAttributes(textAppearanceResId, R.styleable.TextAppearance);
    try {
  ...
  public static class LayoutParams extends Toolbar.LayoutParams
    ...
    @Override public AutoLayoutInfo getAutoLayoutInfo() {
