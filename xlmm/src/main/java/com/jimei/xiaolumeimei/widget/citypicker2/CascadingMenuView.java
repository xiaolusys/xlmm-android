...
import com.jimei.xiaolumeimei.widget.citypicker2.adapter.MenuItemAdapter;
...
public class CascadingMenuView extends LinearLayout {
  ...
  private void init(final Context context) {
    ...
    firstMenuListViewAdapter =
        new MenuItemAdapter(context, menuItem, R.mipmap.choose_item_selected,
    ...
    firstMenuListViewAdapter.setOnItemClickListener(
    ...
    secondMenuListViewAdapter =
        new MenuItemAdapter(context, secondItem, R.mipmap.choose_item_selected,
            R.drawable.choose_eara_item_selector);
    ...
    secondMenuListViewAdapter.setOnItemClickListener(
        new MenuItemAdapter.OnItemClickListener() {
    ...
    thirdMenuListViewAdapter =
        new MenuItemAdapter(context, thirdItem, R.mipmap.choose_item_selected,
    ...
    thirdMenuListViewAdapter.setOnItemClickListener(
        new MenuItemAdapter.OnItemClickListener() {
