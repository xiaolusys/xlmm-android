...
public class WithdrawCashHisAdapter extends BaseAdapter {
  ...
  @Override public View getView(int position, View convertView, ViewGroup parent) {
    ...
    if (convertView == null) {
      ...
      convertView =
          LayoutInflater.from(context).inflate(R.layout.item_withdrawcash_record, null);
    ...
    WithdrawCashHisBean.WithdrawCashRecord record =
        (WithdrawCashHisBean.WithdrawCashRecord) getItem(position);
    if (null != record) {
