...
public class PullToZoomScrollViewEx extends PullToZoomBase<ScrollView> {
  ...
  public PullToZoomScrollViewEx(Context context, AttributeSet attrs) {
    ...
    ((InternalScrollView) mRootView).setOnScrollViewChangedListener(
        new OnScrollViewChangedListener() {
          @Override public void onInternalScrollChanged(int left, int top, int oldLeft,
              int oldTop) {
  ...
  @Override protected void pullHeaderToZoom(int newScrollValue) {
   ...
   */
  @Override public void setHideHeader(boolean isHideHeader) {
  ...
  @Override public void setHeaderView(View headerView) {
    if (headerView != null) {
  ...
  @Override public void setZoomView(View zoomView) {
    if (zoomView != null) {
      mZoomView = zoomView;
      updateHeaderView();
    }
  ...
  @Override protected void smoothScrollToTop() {
  ...
  @Override public void handleStyledAttributes(TypedArray a) {
      ...
      if (mZoomView != null) {
        ...
        if ((!mIsFinished) && (mScale > 1.0D)) {
          float f1 = ((float) SystemClock.currentThreadTimeMillis() - (float) mStartTime)
              / (float) mDuration;
          f2 = mScale
              - (mScale - 1.0F) * PullToZoomScrollViewEx.sInterpolator.getInterpolation(
              f1);
