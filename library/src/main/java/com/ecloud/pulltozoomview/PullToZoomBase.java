...
public abstract class PullToZoomBase<T extends View> extends LinearLayout
  ...
  private void init(Context context, AttributeSet attrs) {
    ...
    if (attrs != null) {
      ...
      //初始化状态View
      TypedArray a =
          getContext().obtainStyledAttributes(attrs, R.styleable.PullToZoomView);
  ...
  @Override public T getPullRootView() {
    return mRootView;
  }

  @Override public View getZoomView() {
    return mZoomView;
  }
  ...
  @Override public boolean isPullToZoomEnabled() {
    return isZoomEnabled;
  }

  @Override public boolean isZooming() {
    return isZooming;
  }

  @Override public boolean isParallax() {
    return isParallax;
  }
  ...
  @Override public boolean isHideHeader() {
    return isHideHeader;
  }
